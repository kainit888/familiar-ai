...
# Playback wait/grace のデフォルトは実機検証 (2026-05-23, Tapo C210) で
# 4 チャンク発話のテンポ感と抜け落ち無しを両立する値に確定。
DEFAULT_TTS_PLAYBACK_STABLE_THRESHOLD = 3
DEFAULT_TTS_PLAYBACK_MAX_WAIT_MS = 10000
DEFAULT_TTS_PLAYBACK_POLL_INTERVAL_MS = 80
DEFAULT_TTS_PLAYBACK_GRACE_MS = 450
DEFAULT_TTS_PLAYBACK_FINAL_GRACE_MS = 500
_TTS_PUNCT = "。、！？!?.,"
